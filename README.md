...
<p align="center">
  I use GitHub to document what I build, keep track of what I learn,<br/>
  and turn small experiments into reusable projects.
</p>
...
**Frontend:** JavaScript, TypeScript, React, React Hooks, React Router, React Hook Form, Context API, Redux, Zustand, Tailwind CSS, Styled-components, Vite, GSAP, Mobile-First Design, Memoization, SEO / GA

**Backend / AI:** Python, OpenAI API, RAG, Claude Code / Antigravity, Whisper, Deepgram, MediaPipe, n8n, Streamlit, Axios, Firebase, Supabase, MySQL, Nginx, AWS, Cloudflare, Railway, Vercel, GitHub Pages

**Dev Tools / Collaboration:** Git, npm / yarn, ESLint, Prettier, Husky, Vitest, MSW, Apify, Web Scraping / Automation, GitHub Projects, Jira, Notion, Slack, Discord, Agile / Scrum
...
<p>
  <a href="https://github.com/ganimjeong">
    <img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" alt="GitHub" />
  </a>
